                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading"><h6 class="panel-title">Attended Imprest</h6></div>
                            <div class="datatable">
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                        $counter = 1;
                                        $getitem = "SELECT * FROM imprest WHERE status=5 AND imprest_id IN(SELECT imprest_id FROM  imprest_voucher WHERE addedby='".$arraylogUser['user_id']."')";
                                        ...
                                        while ($result = mysqli_fetch_array($query)) {
                                           ...
                                           // get total amount
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $arrayv['voucher_no']; ?></td>
