        ...
        <div class="page-container container-fluid">
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <h5><i class="fa fa-warning"></i><a href="imprest_accountant_checked.php"><font color="white">All Imprest</font></a></h5>
                </div>
                <!-- /page title -->
                            ...
                            <tbody>
                                ...
                                ?>   
                                    <tr>
                                        <td><b>Remarks:</b></td>
                                    <td><b><?php
                                    $s = "SELECT * FROM imprest_accountant_check WHERE imprest_id='$id'";
                                    ...
                                    <td>
                                        <b> <?php echo $arrays['checked_date'];?></b>
                                    </td>
                                    </tr>
