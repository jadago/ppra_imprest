                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading"><h6 class="panel-title">Checked Imprest Request</h6></div>
                            <div class="datatable">
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                        $counter = 1;
                                        $getitem = "SELECT * FROM imprest WHERE status > 2 AND imprest_id IN(SELECT imprest_id FROM imprest_accountant_check WHERE checked_by='".$arraylogUser['user_id']."')";
                                        ...
                                        while ($result = mysqli_fetch_array($query)) {
                                           ...
                                           // get total amount
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="imprest_checked_preview.php?id=<?php echo $result['imprest_id'];?>"><span class="label label-primary">Preview the imprest</span></a></td>
