...
if (isset($_POST['Submit'])) {
 ...
 $decision = isset($_POST['approval']) ? $_POST['approval']:'';
 $imprest_id = isset($_POST['imprest_id']) ? $_POST['imprest_id']:'';
 
 $insert = "INSERT INTO  imprest_approval(imprest_id,remarks,decision,approved_by,approval_date) VALUES ('$imprest_id','$remarks','$decision','$addedby','$approved_date')";
 ...
 if($query)
 {
     ...
     if($decision==1)
     {
     $update  = "UPDATE imprest SET status = '4' WHERE imprest_id='$imprest_id'";
     }
 else {
       $update  = "UPDATE imprest SET status = '100' WHERE imprest_id='$imprest_id'";  
     }
     $queryu = mysqli_query($con,$update);
     header('Location: imprest_approval.php');
     exit();
 }
 else {
        ...
        <div class="page-container container-fluid">
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <h5><i class="fa fa-warning"></i><a href="imprest_approval.php"><font color="white">All Imprest</font></a></h5>
                </div>
                <!-- /page title -->
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ?>  
                                    ...
                                    <td><?php 
                                    $a = "SELECT * FROM imprest_accountant_check WHERE imprest_id='$id'";
                                    $queryA = mysqli_query($con,$a);
                                    $arrayA = mysqli_fetch_array($queryA);
                                   
                                    $c = "SELECT * FROM users WHERE user_id='".$arrayA['checked_by']."'";
                                    $queryC = mysqli_query($con,$c);
                                    $arrayC = mysqli_fetch_array($queryC);
                                    echo $arrayA['remarks']."<br/>";
                                    echo "<b><i>"."Checked by:"." ".$arrayC['firstname']." ".$arrayC['lastname'];
                                    ?></td>
                                    </tr>
                                    <tr>
                                    <td>Remarks:</td>
                                    ...
                                    <select  class="select"  name="approval"  style="width:210px;" required>
