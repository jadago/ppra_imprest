...
if (isset($_POST['Submit'])) {
 ...
 $insert = "INSERT INTO  retirement_approval(imprest_id,remarks,decision,approved_by,approval_date) VALUES ('$imprest_id','$remarks','$decision','$addedby','$approved_date')";
 ...
 if($query)
 {
     ...
     if($decision==1)
     {
     $update  = "UPDATE imprest SET stage = '4' WHERE imprest_id='$imprest_id'";
     }
 else {
       $update  = "UPDATE imprest SET stage = '100' WHERE imprest_id='$imprest_id'";  
     }
     $queryu = mysqli_query($con,$update);
     header('Location: imprest_retirement_approval.php');
     exit();
 }
 else {
...
//get user details
                ...
                <div class="page-title">
                    <h5><i class="fa fa-warning"></i><a href="imprest_retirement_approval.php"><font color="white">All Imprest</font></a></h5>
                </div>
                <!-- /page title -->
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="white">
                                            <?php
                                            $ap = "SELECT * FROM imprest WHERE imprest_id='$id' AND stage > 3";
